...
# default
with open('./results/ref_dict_Version00_checkpoint_msrvtt2016_5_cap.pickle', mode='rb') as fi:
    ref_dict = cPickle.load(fi)

# hypo
# default
with open('./results/hypo_dict_Version00_checkpoint_msrvtt2016_5_cap.pickle', mode='rb') as fg:
    hypo_dict = cPickle.load(fg)


#for ID in IDs:
#    ref[ID] = ref_dict[ID]
#    hypo[ID] = hypo_dict[ID]
